...
cmdDirectiveName = (utils.isHyphenated(cmdDirectiveName)) ? cmdDirectiveName.toLowerCase() : cmdDirectiveName;
...
var vals = {
    ...
    pName: utils.pascalCase(_.camelCase(cmdDirectiveName)),
    name: _.camelCase(cmdDirectiveName),
